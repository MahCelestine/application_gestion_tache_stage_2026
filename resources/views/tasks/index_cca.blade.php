<x-layout>
    ...
    <table class="w-[100%] border-separate border-spacing-y-4">
        <thead class="text-lg">
            <tr>
                <th class="py-6 rounded-tl-3xl border-t-2 border-b-2 border-l-2 border-gray-300 w-[10%]">
                    @php
                ...
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[20%]">
                    @php
                ...
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[10%]">État</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]">Assignation</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]">Délai</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]">Temps donné</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]">Temps réel</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]">Compteur temps</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]"></th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[9%]"></th>
                <th class="py-6 rounded-tr-3xl border-t-2 border-b-2 border-r-2 border-gray-300 w-[9%]"></th>
            </tr>
        </thead>
                ...
                @if ($task->status !== 'validé' || $filterStatus || $search)
                    <tbody class="task-group-border shadow-md">
                        ...
                        <tr class="text-lg">
                            ...
                            <td class="text-center"><a href="{{ route('tasks.edit', ['task' => $task->id, 'context' => 'cca']) }}"
                        ...
                        @foreach ($task->subtasks as $subtask)
                            <tr>
                                <td></td>
                                <td><a href="{{ route('subtasks.edit', ['subtask' => $subtask->id, 'context' => 'cca']) }}"
                                        class="text-blue-500 hover:text-blue-600 hover:font-semibold">Modifier</a>
                                </td>
                                <td>{{ $subtask->label }}</td>
