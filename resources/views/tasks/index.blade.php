<x-layout>
    <x-slot:searchBar>
        <x-search-bar :route="route('tasks.index')" />
    </x-slot:searchBar>
    <x-slot:ajoutTache>
    ...
    <table class="w-[100%] border-separate border-spacing-y-4">
        <thead class="text-lg">
            <tr>
                ...
                <th class="py-6 border-t-2 border-b-2 border-gray-300">Devis</th>
                <th class="py-6 border-t-2 border-b-2 border-gray-300">Facturation</th>
            ...
            @if ($task->status !== 'validé' || $filterStatus || $search)
                <tbody class="task-group-border shadow-md">
                    ...
                    <tr class="text-lg">
                        ...
                        <td><a href="{{ route('tasks.edit', $task->id) }}" class="text-blue-500 hover:text-blue-600 hover:font-semibold">Modifier</a></td>
                    </tr>
                    ...
                    @foreach ($task->subtasks as $subtask)
                        <tr>
                            <td></td>
                            <td><a href="{{ route('subtasks.edit', $subtask->id) }}" class="text-blue-500 hover:text-blue-600 hover:font-semibold">Modifier</a></td>
                            <td>{{ $subtask->label }}</td>
