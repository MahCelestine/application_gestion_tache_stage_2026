    ...
    <table class="w-[100%] border-separate border-spacing-y-4">
        <thead class="text-lg">
            <tr>
                ...
                <th class="py-6 border-t-2 border-b-2 border-gray-300 w-[8%]">Payé</th>
            </tr>
        </thead>
        @foreach ($tasks as $task)
                    <tbody class="task-group-border shadow-md">
                        ...
                        <tr class="text-lg">
                            ...
                            <td class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full border border-green-400">
                                    {{ $task->is_paid ? 'Payé' : 'Non payé' }}</td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        @foreach ($task->subtasks as $subtask)
                            <tr>
                                ...
                                <td class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full border border-green-400">
                                    {{ $subtask->is_paid ? 'Payé' : 'Non payé' }}</td>
                            </tr>
                            </div>
                        @endforeach
                    </tbody>
