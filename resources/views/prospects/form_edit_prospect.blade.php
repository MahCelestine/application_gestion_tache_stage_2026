<x-layout>
    <form action="{{ route('prospects.update', $prospect->id) }}" method="POST">
        ...
        <div class="border-2 border-gray-300 rounded-xl shadow-md mb-8">
            <h2 class="text-2xl mx-6 my-6">Modifier un prospect</h2>
            ...
            <div class="flex my-6">
                <div class="basis-2/4 mx-5">
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <input type="text" name="source" placeholder="Source du contact" value="{{ $prospect->source }}"
                            class="my-4 text-lg rounded-lg border-2 w-[90%] border-gray-300 focus:border-gray-400 focus:outline-gray-400 text-gray-600 px-2 py-1" />
                    </div>
                    <div class="flex flex-col">
                        <label class="text-xl font-semibold">Relance</label>
                ...
                <div class="basis-1/4 mx-5">
                    <div class="flex flex-col mb-6">
                        ...
                        <select name="status" id="status-select"
                            ...
                            <option value="RDV à prendre" {{ $prospect->status == 'RDV à prendre' ? 'selected' : '' }}>RDV
                                à prendre</option>
                            <option value="Date de RDV" {{ $prospect->status == 'Date de RDV' ? 'selected' : '' }}>Date de
                                RDV</option>
                    ...
                    <div id="date_rdv" style="display: none;">
                        ...
                        <input type="date" name="rdv_date" id="rdv-input"
                            ...
                            class="my-4 text-lg rounded-lg border-2 w-[90%] border-gray-300 focus:border-gray-400 focus:outline-gray-400 text-gray-600 px-2 py-1" />
                        <span id="date-error" class="text-red-500 text-sm font-bold block mb-2" style="display: none;">
                ...
                <div class="basis-1/4 mx-5">
                    <div class="flex flex-col mb-6">
                        <label class="text-xl font-semibold">Réponse</label>
                        ...
                        <select name="response_type" id="response-select"
                            class="my-4 text-lg rounded-lg border-2 w-[90%] border-gray-300 focus:border-gray-400 focus:outline-gray-400 text-gray-600 px-2 py-1 disabled:bg-gray-100 disabled:cursor-not-allowed">
                            <option value=""></option>
        ...
        <div class="border-2 border-gray-300 rounded-xl shadow-md mb-8">
            ...
            <div class="flex flex-col mx-5 my-6">
                ...
                <textarea name="note" placeholder="Information sur le prospect"
                    class="my-4 text-lg rounded-lg border-2 w-[95%] border-gray-300 focus:border-gray-400 focus:outline-gray-400 text-gray-600 px-2 py-1">@if($prospect->notes->isNotEmpty()){{ $prospect->notes->last()->description }}@endif</textarea>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center mb-10">
            ...
            <button type="submit"
                class="bg-blue-500 hover:bg-blue-600 text-white py-4 font-semibold rounded-lg w-[20%] shadow-md transition-all">
                Valider
            </button>
        </div>
    </form>
    ...
    <div class="mx-6 mb-10">
        <form action="{{ route('prospects.destroy', $prospect->id) }}" method="POST"
            onsubmit="return confirm('Voulez-vous supprimer ce prospect ?');">
            @csrf
            @method('DELETE')
