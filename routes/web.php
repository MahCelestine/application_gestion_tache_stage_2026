...
Route::middleware(['auth'])->group(function () {
    ...
    // Ta page d'accueil devient ton index de tâches sécurisé
    ...
    Route::get('/daily-assignments/{dailyAssignment}', [DailyAssignmentController::class, 'show'])->name('daily-assignments.show');
